...
mkdir -p review_test
RUSTFLAGS="-Awarnings -C link-args=-zstack-size=1024" cargo +nightly build --target wasm32-unknown-unknown --release
...
cp ../../target/wasm32-unknown-unknown/release/review_test.wasm review_test/review_test.wasm
